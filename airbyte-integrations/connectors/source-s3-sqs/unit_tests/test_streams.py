...
import pytest
from source_s3_sqs.source import S3SqsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(S3SqsStream, "path", "v0/example_endpoint")
    mocker.patch.object(S3SqsStream, "primary_key", "test_primary_key")
    mocker.patch.object(S3SqsStream, "__abstractmethods__", set())
